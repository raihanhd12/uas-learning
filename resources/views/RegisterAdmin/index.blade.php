		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="../assets/img/register-bg-admin-fix.png" alt="IMG">
				</div>

				<form class="login100-form validate-form" action="/registeradmin" method="POST">
					@csrf
					<span class="login100-form-title" style="color: #d400c3">
						REGISTER
						<p style="color: white">Selamat Datang Admin RHDLearning. Masukkan Data !</p>
					</span>
					...
					<input class="input100 @error('is_admin') is-invalid @enderror" type="hidden" name="is_admin" placeholder="is_admin" id="is_admin" value="1" required>

					<input class="input100 @error('is_status') is-invalid @enderror" type="hidden" name="is_status" placeholder="is_status" id="is_status" value="1" required>

									
					
					<div class="container-login100-form-btn">
						<button style="background-color: #b100a2" class="login100-form-btn" type="submit">
							Register
						</button>
					</div>

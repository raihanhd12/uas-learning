...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
        <form method="POST" action="/dashboard/lesson" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('videotitle') is-invalid @enderror" id="videotitle" name="videotitle" required autofocus value="{{ old('videotitle') }}">
                @error('videotitle')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('video') is-invalid @enderror" id="video" name="video" value="{{ old('video', "https://www.youtube.com/watch?v=LUAMxzUEZ7g") }}">
                @error('video')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>

        ...
        <form method="POST" action="/dashboard/courses" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="course_category_id">
                    ...
                    @if (old('course_category_id') == $course_category->id)                        
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="course_level_id">
                    ...
                    @if (old('course_level_id') == $course_level->id)                        
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="course_price_id">
                    ...
                    @if (old('course_price_id') == $course_price->id)                        
            ...
            <div class="mb-3">
                ...
                <input id="learn" type="hidden" name="learn"  value="{{ old('learn') }}">
